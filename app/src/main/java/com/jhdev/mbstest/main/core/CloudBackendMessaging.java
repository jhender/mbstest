...
public class CloudBackendMessaging extends CloudBackendAsync {
    ...
    /**
     * Kind name of {@link com.jhdev.mbstest.main.core.CloudEntity} for Cloud Message.
     */
    ...
    private final Map<String, com.jhdev.mbstest.main.core.CloudCallbackHandler<List<com.jhdev.mbstest.main.core.CloudEntity>>> mMessageHandlers =
            new HashMap<String, com.jhdev.mbstest.main.core.CloudCallbackHandler<List<com.jhdev.mbstest.main.core.CloudEntity>>>();
     ...
     * @param cloudMsgHandler {@link com.jhdev.mbstest.main.core.CloudCallbackHandler} that will handle
     *            Cloud Message for the topic. It will receive {@link java.util.List} of
     *            {@link com.jhdev.mbstest.main.core.CloudEntity}s that contain the messages.
    ...
    public void subscribeToCloudMessage(String topicId,
            com.jhdev.mbstest.main.core.CloudCallbackHandler<List<com.jhdev.mbstest.main.core.CloudEntity>> handler, int... maxOfflineMessages) {
    ...
    private class CloudMessageHandler extends com.jhdev.mbstest.main.core.CloudCallbackHandler<List<com.jhdev.mbstest.main.core.CloudEntity>> {
        ...
        @Override
        public void onComplete(List<com.jhdev.mbstest.main.core.CloudEntity> messages) {
            ...
            com.jhdev.mbstest.main.core.CloudEntity lastMsg = messages.get(0);
            ...
            com.jhdev.mbstest.main.core.CloudCallbackHandler<List<com.jhdev.mbstest.main.core.CloudEntity>> handler = mMessageHandlers.get(topicId);
            if (handler == null) {
                return;
            }
     ...
     */
    public void sendCloudMessage(com.jhdev.mbstest.main.core.CloudEntity message) {
     ...
     *
     * @param message properties to include in the message
     * @param handler {@link com.jhdev.mbstest.main.core.CloudCallbackHandler} that has
     ...
     */
    public void sendCloudMessage(com.jhdev.mbstest.main.core.CloudEntity message, com.jhdev.mbstest.main.core.CloudCallbackHandler<com.jhdev.mbstest.main.core.CloudEntity> handler) {
        super.insert(message, handler);
    }

    /**
     * Creates a {@link com.jhdev.mbstest.main.core.CloudEntity} that represent a Cloud Message. You can use
     * {@link #sendCloudMessage(com.jhdev.mbstest.main.core.CloudEntity)} to send out the message.
     *
     * @param topicId
     * @return
     */
    public com.jhdev.mbstest.main.core.CloudEntity createCloudMessage(String topicId) {
        com.jhdev.mbstest.main.core.CloudEntity ce = new com.jhdev.mbstest.main.core.CloudEntity(KIND_NAME_CLOUD_MESSAGES);
        ce.put(PROP_TOPIC_ID, topicId);
        return ce;
    }

    /**
     * Creates a {@link com.jhdev.mbstest.main.core.CloudEntity} for message broadcasting. You can use
     * {@link #sendCloudMessage(com.jhdev.mbstest.main.core.CloudEntity)} to send out the message.
     *
     * @return {@link com.jhdev.mbstest.main.core.CloudEntity}
     */
    public com.jhdev.mbstest.main.core.CloudEntity createBroadcastMessage() {
